...
/// </summary>
public sealed class SimpleBankAppProblemDetailsFactory : ProblemDetailsFactory
{
    ...
    public SimpleBankAppProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
